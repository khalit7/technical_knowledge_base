...
*This copy is the page as Notion last edited it, 2026-09-23 03:23:00 UTC. A procedure*
...
It prints the smallest reserve per beat that keeps every lead inside tolerance, against the cap that beat can actually reach, and says outright when no reserve can close it: `RESERVE CANNOT FIX IT: add a panel row, or move the words`. Two authors wrote this by hand before it existed, one of them twice, because a re-render moved the durations underneath the first attempt.

...
- [2024-02_deepseekmath-grpo](../2024-02_deepseekmath-grpo/): introduced GRPO; R1 is GRPO scaled up with verifiable instead of learned rewards. Read its "Why it matters" for the Dr. GRPO/DAPO fixes to bake into your own loop.
- [2024-12_deepseek-v3](../2024-12_deepseek-v3/): the 671B MoE base model both R1-Zero and R1 start from; its SFT data supplies the 200k non-reasoning samples.
- [2022-03_instructgpt](../2022-03_instructgpt/): the SFT-then-RLHF paradigm this paper partially inverts (RL before any reasoning SFT, rules before reward models).
- [2023-05_dpo](../2023-05_dpo/): the offline alternative for preference alignment; R1's stage 4 shows where online RL with preference RMs still gets used, and its hacking risk.
- [2025-05_qwen3](../2025-05_qwen3/): a descendant reasoning-model family trained with an R1-style long-CoT RL pipeline; Qwen2.5 models are also the distillation students here.
- KB topics: [topics/rl](../../topics/rl/) (RLVR, GRPO, RL for LLMs), [topics/llm-training-and-post-training](../../topics/llm-training-and-post-training/) (post-training pipelines, distillation, reward hacking).

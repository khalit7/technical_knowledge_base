...
- Attention Is All You Need (2017-06): the encoder ViT reuses nearly unchanged
- BERT (2018-10): source of the [class] token, model sizing, and the masked-prediction pre-training idea
- Scaling Laws for Neural Language Models (2020-01): the NLP scaling story whose vision counterpart this paper establishes
- CLIP (2021-02): pairs a ViT image encoder with a text encoder; the main vehicle through which ViT reached multimodal models
- DDPM (2020-06) and Latent Diffusion (2021-12): the diffusion line that later swapped its U-Net for ViT-style DiT backbones
- KB topics: generative-and-multimodal

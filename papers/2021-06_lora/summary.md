...
- [`papers/2023-05_qlora`](../2023-05_qlora/): 4-bit quantized base + LoRA; the combination that democratized fine-tuning
- [`papers/2020-05_gpt-3`](../2020-05_gpt-3/): the 175B stress-test model whose deployment cost motivated LoRA
- [`papers/2018-10_bert`](../2018-10_bert/): RoBERTa/DeBERTa, the encoder evaluation targets on GLUE
- [`papers/2023-05_dpo`](../2023-05_dpo/) and [`papers/2024-02_deepseekmath-grpo`](../2024-02_deepseekmath-grpo/): preference and RL post-training, in practice frequently run on LoRA adapters
- [`papers/2023-09_vllm-pagedattention`](../2023-09_vllm-pagedattention/): the serving side; multi-LoRA batching over one base model lives here

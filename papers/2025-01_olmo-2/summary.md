...
- Related papers here: DeepSeek-V3 and Llama 3 (the open-weights recipes OLMo 2 makes transparent), Chinchilla (compute-optimal background; OLMo 2 trains far past Chinchilla-optimal), DeepSeekMath/GRPO (GRPO used for 1B/32B RLVR), DPO (preference stage), RoFormer (RoPE), ZeRO and Megatron-LM (distributed training lineage)

...
- papers/2025-01_deepseek-r1: the reasoning-RL paradigm Qwen3 adopts (cold start then RL); its distilled models are the direct baselines Qwen3's small models beat, and Qwen3 answers its RL-vs-distillation question in favor of distillation for students.
- papers/2024-02_deepseekmath-grpo: GRPO, the algorithm used in Qwen3's reasoning RL stage.
- papers/2024-12_deepseek-v3: the rival open MoE flagship; Qwen3-235B-A22B-Base overtakes it with a third of the parameters, via more tokens rather than architectural exotica (no MLA, no shared experts, no MTP).
- papers/2021-01_switch-transformer and papers/2024-01_mixtral: the MoE lineage behind Qwen3's fine-grained 128-expert, 8-active design.
- papers/2021-04_roformer-rope: RoPE, extended here via ABF base scaling plus YaRN and Dual Chunk Attention.
- papers/2024-07_llama-3: the competing open-family technical report; Qwen3's comparisons against Llama-4 Maverick/Scout mark the moment the open-weight lead moved east.

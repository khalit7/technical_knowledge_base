...
- [Chinchilla (2022)](../2022-03_chinchilla/summary.md): the direct successor; revises the compute-optimal allocation to equal N and D scaling (~20 tokens/param).
- [GPT-3 (2020)](../2020-05_gpt-3/): the first frontier model built on these prescriptions (large N, one epoch, stopped short of convergence).
- [Attention Is All You Need (2017)](../2017-06_attention-is-all-you-need/): the architecture whose parallelism made these compute scales reachable.
- [Llama 3 (2024)](../2024-07_llama-3/) and [DeepSeek-V3 (2024)](../2024-12_deepseek-v3/): the modern regime of deliberately overtraining far beyond compute-optimal to cheapen inference.

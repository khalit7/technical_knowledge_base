...
- [Anthropic engineering: Equipping agents for the real world with Agent Skills](https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills) (~15 min): the canonical description of the [SKILL.md](http://skill.md/) abstraction this paper dissects (progressive disclosure, folder layout, when to write one).

...
- `papers/2017-06_attention-is-all-you-need`: the additive sinusoidal encoding whose frequency spectrum RoPE reuses multiplicatively
- `papers/2018-10_bert`: the pretraining baseline RoFormer swaps its APE out of
- `papers/2024-07_llama-3`: RoPE at base 500k plus staged long-context extension; the mainstream deployment pattern
- `papers/2024-12_deepseek-v3`: MLA's decoupled RoPE keys, the trick that reconciles RoPE with latent KV compression
- `papers/2024-01_mixtral`: representative RoPE-based open-weight architecture

...
- InstructGPT (2022-03): the three-stage RLHF pipeline DPO collapses into one loss.
- Constitutional AI (2022-12): RLAIF preference data; DPO consumes such pairs directly.
- DeepSeekMath / GRPO (2024-02): the online-RL counterpoint that now dominates reasoning post-training.
- DeepSeek-R1 (2025-01): RLVR at scale, the other pole of the DPO-vs-online-RL debate.
- Llama 3 (2024-07) and OLMo 2 (2025-01): production pipelines with DPO stages.

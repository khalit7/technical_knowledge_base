...
- [`papers/2017-06_attention-is-all-you-need`](../2017-06_attention-is-all-you-need/): BERT is the Transformer encoder stack, transplanted to transfer learning
- [`papers/2025-07_ettin`](../2025-07_ettin/): modern controlled comparison of the encoder (BERT) and decoder (GPT) lineages using the ModernBERT recipe
- [`papers/2020-05_gpt-3`](../2020-05_gpt-3/): the rival unidirectional lineage; GPT-3 replaced fine-tuning with in-context learning, ending BERT-style per-task heads for generation tasks
- [`papers/2020-05_rag`](../2020-05_rag/): RAG's dense retriever (DPR) is a pair of BERT encoders; retrieval and embeddings are BERT's main living habitat
- [`papers/2021-04_roformer-rope`](../2021-04_roformer-rope/): RoPE replaced BERT's learned absolute positions in modern encoders (ModernBERT) as well as decoders

...
- [BERT (2018)](../2018-10_bert/): the encoder stack alone, pretrained bidirectionally.
- [GPT-3 (2020)](../2020-05_gpt-3/) and [Scaling Laws (2020)](../2020-01_scaling-laws/): the decoder stack scaled; the parallelism this paper unlocked is what made those curves reachable.
- [RoFormer/RoPE (2021)](../2021-04_roformer-rope/): replaces the sinusoidal positional encoding.
- [FlashAttention (2022)](../2022-05_flashattention/) and [vLLM/PagedAttention (2023)](../2023-09_vllm-pagedattention/): attack the attention memory/IO costs this architecture created.
- [ViT (2020)](../2020-10_vit/): the same encoder applied to image patches.
- [Mamba (2023)](../2023-12_mamba/): the main post-Transformer attempt to remove the O(n^2) attention core.

...
- **[update]** [Real-time and event delivery: WebSockets, SSE, webhooks, long polling](../topics/protocols/realtime-and-events.md): the WebSockets section now opens with a pointer to the deep dive and stays scoped to the choose-between-mechanisms question.

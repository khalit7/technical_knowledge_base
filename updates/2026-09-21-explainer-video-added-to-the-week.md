...
Write numbers phonetically in the script. A text-to-speech model reads "3.22x" and "[Z.ai](http://z.ai/)" badly, so the script spells them as spoken words while the on-screen text keeps the real figures.

...
- **[update]** [HTTP](../topics/protocols/http.md): TLS section now points at the deep dive, with a dated correction noting RFC 9846 supersedes RFC 8446 and that 90-day certificates are no longer the norm.
- **[update]** [Auth](../topics/protocols/auth.md): mTLS bullet points at the new page and flags the end of public-CA client certificates.

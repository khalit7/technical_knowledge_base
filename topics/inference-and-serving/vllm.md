...
- [vLLM docs](https://docs.vllm.ai), especially the
  [Architecture Overview](https://docs.vllm.ai/en/latest/design/arch_overview/): entrypoints,
  engine core, scheduler, model runner. Read this before touching the code.
- [PagedAttention paper](https://arxiv.org/abs/2309.06180) (SOSP 2023); local copy and
...
- [vLLM blog](https://vllm.ai/blog): release deep-dives; the 2026 posts on speculative
  decoding, decode context parallelism, and EAGLE 3.1 are current best practice.
- [Contributing guide](https://docs.vllm.ai/en/stable/contributing/) plus the quarterly
  roadmap issues (e.g. [Q1 2026 #32455](https://github.com/vllm-project/vllm/issues/32455),
  [Q2 2026 #39749](https://github.com/vllm-project/vllm/issues/39749)).
...
- **Disaggregation and scale-out**: KV connector API (NIXL, LMCache, Mooncake) for
  ...
  [llm-d](https://docs.vllm.ai/en/latest/deployment/integrations/llm-d/), NVIDIA Dynamo,
...
1. **Setup**: fork, `uv pip install -e .` from source, run `pre-commit`; read the
   [contributing guide](https://docs.vllm.ai/en/stable/contributing/). PRs need tests;
...
5. **Community**: developer Slack (slack.vllm.ai), biweekly office hours, RFC

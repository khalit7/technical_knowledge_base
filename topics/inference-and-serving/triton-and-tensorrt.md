...
1. **NVIDIA Triton Inference Server**: a C++ HTTP/gRPC model-serving server. This page.
2. **OpenAI Triton**: a Python DSL for writing GPU kernels (what vLLM kernels are often
   written in). Covered in [Triton](../cuda-and-gpu-programming/triton-language.md).
...
- [Inference techniques: what actually makes serving fast](inference-techniques.md): disaggregation, in-flight batching, FP8/FP4.
- [vLLM](vllm.md), [SGLang](sglang.md).

...
- [vLLM](vllm.md), [Inference techniques: what actually makes serving fast](inference-techniques.md) (quantised serving, bandwidth math).
- GPU architecture details: [Topic: hardware](../hardware/summary.md).

...
inference prefill; see [../../papers/2022-05_flashattention/summary.md](../../papers/2022-05_flashattention/summary.md).
...
(LMCache, Mooncake, Dynamo KVBM) spill cold prefixes to CPU/SSD/object storage.
...
schedulers now adapt draft length by load (e.g. vLLM's DSpark-style adaptive verification).

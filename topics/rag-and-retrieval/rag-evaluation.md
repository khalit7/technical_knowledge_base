...
- **nDCG@k**: rank-weighted, handles graded relevance; the standard for comparing
...
against a hand-labeled sample (see ../evaluation-and-llm-judges/). And a system can
...
- **DeepEval**: pytest-style assertions, good CI ergonomics.
...
1. Mine real queries (logs, support tickets, SME interviews); synthetic-only sets
...
with citations verified against sources. This overlaps with agent evals generally; see
[../evaluation-and-llm-judges/summary.md](../evaluation-and-llm-judges/summary.md).

## See also

- [retrieval-pipeline.md](retrieval-pipeline.md): the stages these metrics diagnose.
- [advanced-and-agentic-rag.md](advanced-and-agentic-rag.md): what changes for loops.

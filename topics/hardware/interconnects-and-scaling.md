...
- **TPU ICI**: the contrast case: no switches at all, direct chip-to-chip torus
  links plus optical circuit switches at cube boundaries (see [TPUs: systolic arrays and pod-scale machines](tpus.md)).
...
- Full parallelism math and implementations:
  ...
  and [Sharding and scale: GSPMD, Mesh, shard_map](../jax-and-tpu/sharding-and-scale.md).

...
- Torus consequences: bisection bandwidth grows with the torus, nearest-neighbour
  ...
  thinking (see [Sharding and scale: GSPMD, Mesh, shard_map](../jax-and-tpu/sharding-and-scale.md))
...
- TPU torus + OCS scales one training job to ~10k chips as a single fabric;
  ...
  (see [Interconnects and scaling: why the network picks your parallelism](interconnects-and-scaling.md)).

...
See also: [Model Context Protocol (MCP)](mcp.md), [HTTP: 1.1, 2, 3, and what matters for LLM services](http.md) (TLS), [RPC and API styles: REST, gRPC, GraphQL](rpc-and-apis.md).

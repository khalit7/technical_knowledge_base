...
- TLS as a dependency of HTTP versions, ALPN, and Alt-Svc: [HTTP: 1.1, 2, 3](http.md) (13 min read · +19h 40m resources).
- Tokens, OAuth, and where mTLS fits among service-to-service options: [Auth](auth.md) (11 min read · +9h resources).
- CAA records, DNS-01 validation, and the HTTPS/SVCB record that carries the ECH key: [DNS](dns.md) (21 min read · +6h 15m resources).
- Host keys, TOFU, and SSH's parallel post-quantum migration: [SSH](ssh.md) (21 min read · +7h resources).

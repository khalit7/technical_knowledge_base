...
- vLLM production stack and llm-d docs (docs, ~1h for the core pages) (see topics/inference-and-serving): what the routing layer actually looks like in 2026
...
1. **Offline evals** gate the candidate (regression suite, see [testing-and-quality.md](testing-and-quality.md)).

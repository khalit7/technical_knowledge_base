...
| Vector | ANN search over embeddings | pgvector, Qdrant, Milvus, Turbopuffer | RAG retrieval, semantic cache, dedup (see topics/rag-and-retrieval) |

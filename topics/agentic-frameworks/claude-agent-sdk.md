...
- **MCP** (Model Context Protocol): first-class client. Point `mcpServers` at stdio, HTTP or SSE (Server-Sent Events) servers and their tools appear alongside the built-ins; this is the integration story for issue trackers, databases, browsers. See [Model Context Protocol (MCP)](../protocols/mcp.md) for MCP itself.
...
- The harness this SDK extracts: [Topic: agentic-harnesses](../agentic-harnesses/summary.md)

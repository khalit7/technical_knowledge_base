...
- [Langfuse docs](https://langfuse.com/docs) (docs, ~40 min for the core pages): tracing data model (traces/observations/scores), SDKs, self-hosting; the best-documented open option.
...
- [OpenLLMetry](https://github.com/traceloop/openllmetry) (repo, ~15 min for the README): vendor-neutral OTel instrumentation most backends ingest.
...
- **Arize Phoenix**: open source, OTel-native (OpenInference conventions), strong RAG/embedding analysis; Arize AX is the commercial tier.
- **OpenLLMetry (Traceloop)**: not a backend but instrumentation; auto-patches OpenAI/Anthropic/LangChain/LlamaIndex calls into OTel spans exportable to Langfuse, LangSmith, Phoenix, Datadog, or any OTLP collector. The safest choice for portability: instrument once, switch backends by changing an exporter URL.
...
- Judge design for online evals: [../evaluation-and-llm-judges/](../evaluation-and-llm-judges/summary.md)

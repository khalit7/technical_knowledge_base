...
scaffold (bash only)" vs "full agent" columns differ by 10-20 points. Details in
[math-and-coding.md](math-and-coding.md).
...
and planning); covered in [knowledge-and-reasoning.md](knowledge-and-reasoning.md).

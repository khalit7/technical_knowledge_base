...
- **Host structure**: each host owns 4 chips (8 for some v5e configs); multi-host slices
  run one JAX process per host (see [Sharding and scale: GSPMD, Mesh, shard_map](sharding-and-scale.md)).
...
3. **TRC (TPU Research Cloud)**: apply at [sites.research.google/trc](http://sites.research.google/trc) (~5 min); grants ~30 days of
...
- Hardware numbers and GPU-vs-TPU comparison: [TPUs: systolic arrays and pod-scale machines](../hardware/tpus.md)
- CUDA and Triton mental models to contrast with Pallas: [Topic: cuda-and-gpu-programming](../cuda-and-gpu-programming/summary.md)
- Sharding and software view of pods: [Sharding and scale: GSPMD, Mesh, shard_map](sharding-and-scale.md)

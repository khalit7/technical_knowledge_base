...
Cross-links: concept-level DP/TP/PP/ZeRO taxonomy in [Distributed Training](../llm-training-and-post-training/distributed-training.md); interconnect hardware in [TPUs: systolic arrays and pod-scale machines](../hardware/tpus.md); TPU specifics next in [TPU architecture and Pallas](tpu-architecture-and-pallas.md).

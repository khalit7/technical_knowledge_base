...
[Topic: programming-languages: five ladders, and which one you are standing on](https://prod-files-secure.s3.us-west-2.amazonaws.com/13e79c56-ebab-4528-83aa-967a204b1f04/96bc4c82-47de-4c6e-a6f4-35e5f1c2e614/topic_programming_languages_overview.mp4)

⏱ 9 min read · +30 min resources

**All five languages are written as zero to expert**, complete from first principles, with the currency material for Python and C++ kept as separate companion pages. Working knowledge is assumed nowhere; if a stage is already known, its gate question confirms it quickly.
...
graph TD
    ...
    RS --> RSB[GPU kernels in Rust:<br/>cutile-rs, cuda-oxide<br/>shipped 2026-09]
...
| [Rust: zero to expert](rust.md) (22 min read · +40h resources) | Toolchain, ML ecosystem, PyO3, C++ translation appendix |

...
- Target 3.12+ syntax (type statement, PEP 695 generics) in new code; run 3.13/3.14 in production. Try `3.14t` for CPU-bound threaded workloads (data loading, tokenization); check extension compatibility at [py-free-threading.github.io](https://py-free-threading.github.io/) (site, already counted above) first.

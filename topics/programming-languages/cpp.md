...
- Standards status, compiler support, C++ in ML infra: [C++: modern practice and standards status](cpp-staying-current.md)
- CUDA C++ and kernel work: [Topic: cuda-and-gpu-programming](../cuda-and-gpu-programming/summary.md)
- The language that made these rules compile-time checked: [Rust: zero to expert](rust.md)

...
*Created 2026-08-31.* TypeScript is a **type layer over JavaScript, erased at compile time**. Nothing here changes runtime behaviour. Do [javascript.md](javascript.md) Stages 1 and 2 first, or you will attribute JavaScript problems to the type system.
...
TypeScript uses the JavaScript ecosystem's package managers unchanged (npm, Yarn, pnpm, Bun: see [javascript.md](javascript.md) for what each one is and why it exists). What follows is only what differs once types are involved.
...
- The runtime underneath: [javascript.md](javascript.md)
- Harnesses and MCP servers written in TypeScript: ../agentic-harnesses/, ../protocols/

...
Last updated: 2026-08-31 (rewritten: ARC, the architecture choices and the RL stack are now explained rather than named). Per-model files to follow; this page maps the family.

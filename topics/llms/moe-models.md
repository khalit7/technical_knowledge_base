...
Last updated: 2026-09-21 (rewrite process note removed). Seeded from Khalid's own prep notes (2026-08-24); every mechanism named here is described rather than listed.
...
See [LLM Architecture Gallery (rasbt) and the architectural deltas that matter](_comparisons/llm-architecture-gallery.md) (10 min read · +2h resources) for per-model configs, and the family pages for each line's specifics.

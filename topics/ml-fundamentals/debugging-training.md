...
| Saddle point | Optimiser with momentum/adaptivity escapes it (see [Optimisers and learning-rate schedulers](optimisers-and-schedulers.md)) |
...
| Right metrics | Evaluate with precision/recall/F1/AUPRC, never plain accuracy (see [Evaluation metrics](metrics.md)) |
...
- Warmup rationale, schedulers, saddle points: [Optimisers and learning-rate schedulers](optimisers-and-schedulers.md)
- Initialisation and normalisation as gradient fixes: [Normalisation and initialisation](normalisation-and-initialisation.md)

...
- Saturation and dead-ReLU debugging: [Debugging training](debugging-training.md)
- Activation choice interacts with initialisation (Xavier vs He): [Normalisation and initialisation](normalisation-and-initialisation.md)

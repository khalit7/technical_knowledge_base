...
| [MAE](https://arxiv.org/abs/2111.06377) (45 min) (2021) | Masked reconstruction | Mask 75% of ViT patches, reconstruct pixels with a light decoder; BERT-style pretraining for vision, cheap and scalable |
...
- InfoNCE is cross entropy: [Loss functions](losses.md); temperature and softmax: [Activation functions](activations.md)
- Embeddings in retrieval practice: [Topic: rag-and-retrieval](../rag-and-retrieval/summary.md)
- ViT/CLIP architectural detail: [Topic: generative-and-multimodal](../generative-and-multimodal/summary.md)

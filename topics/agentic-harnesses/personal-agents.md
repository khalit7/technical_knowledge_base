...
- The harness engineering these borrow from: [harness-engineering.md](harness-engineering.md), [claude-code.md](claude-code.md)
- The runtimes they host: [openai-and-google-harnesses.md](openai-and-google-harnesses.md), [open-source-harnesses.md](open-source-harnesses.md)
- ACP and MCP as the interop layer: [../protocols/mcp.md](../protocols/mcp.md)
- Trajectory export for RL and finetuning (the Hermes angle): [../rl/rl-for-llms.md](../rl/rl-for-llms.md), [../data-curation-and-datasets/synthetic-and-post-training-data.md](../data-curation-and-datasets/synthetic-and-post-training-data.md)

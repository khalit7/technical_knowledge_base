...
See [harness-engineering.md](harness-engineering.md) for the shared engineering, [claude-code.md](claude-code.md) for the Anthropic side, and [../protocols/](../protocols/summary.md) for MCP itself.

...
Open-source harnesses matter for two reasons: they are the only ones you can read, and they are where harness ideas get tested in public. Each of the below contributes at least one idea worth stealing for anything you build with [../agentic-frameworks/](../agentic-frameworks/summary.md).
...
- 75+ providers via [models.dev](https://models.dev) metadata; agents/modes with per-agent tool and permission sets; LSP integration for diagnostics; plugin system; share-links for sessions.

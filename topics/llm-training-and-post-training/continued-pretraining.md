...
- **Mid-training annealing** (see [pretraining.md](pretraining.md)) is the same
...
See also `topics/data-curation-and-datasets` for mixing infrastructure and
[alignment-and-rlhf.md](alignment-and-rlhf.md) for the re-alignment step.

...
- [RoFormer: Enhanced Transformer with Rotary Position Embedding](../../papers/2021-04_roformer-rope/summary.md): the RoPE original.
...
[RoFormer: Enhanced Transformer with Rotary Position Embedding](../../papers/2021-04_roformer-rope/summary.md). Instead of **adding** a
...
- Long-context also depends on the attention mechanism itself (sliding window +
  ...
  [Topic: inference-and-serving](../inference-and-serving/summary.md) and architecture notes in [Topic: llms](../llms/summary.md).

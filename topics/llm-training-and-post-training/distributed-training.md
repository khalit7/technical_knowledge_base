...
- Papers: [ZeRO: Memory Optimizations Toward Training Trillion Parameter Models](../../papers/2019-10_zero/summary.md), [Megatron-LM: Training Multi-Billion Parameter Language Models Using Model Parallelism](../../papers/2019-09_megatron-lm/summary.md), [Switch Transformers: Scaling to Trillion Parameter Models with Simple and Efficient Sparsity](../../papers/2021-01_switch-transformer/summary.md).
...
Memory per parameter in mixed-precision Adam:

- 2 (bf16 weights) + 2 (bf16 grads) + 12 (fp32 master weight, momentum, variance), in total ~16 bytes, before activations.
ZeRO ([ZeRO: Memory Optimizations Toward Training Trillion Parameter Models](../../papers/2019-10_zero/summary.md)) shards these across the DP
...
- **Tensor parallelism (TP)**: split individual weight matrices "horizontally"
  ([Megatron-LM: Training Multi-Billion Parameter Language Models Using Model Parallelism](../../papers/2019-09_megatron-lm/summary.md)): column-parallel
...
- **Expert parallelism (EP)**: for MoE, distribute experts across GPUs; tokens are
  ...
  means. Origin: [Switch Transformers: Scaling to Trillion Parameter Models with Simple and Efficient Sparsity](../../papers/2021-01_switch-transformer/summary.md);
...
- Activation checkpointing (full or selective) trades ~30% compute for large
  ...
  sweet spot with [FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness](../../papers/2022-05_flashattention/summary.md).

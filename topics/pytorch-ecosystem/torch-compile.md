...
See also: [performance-stack.md](performance-stack.md) for how compile interacts with
SDPA/FlexAttention, and [distributed-pytorch.md](distributed-pytorch.md) for compile
over FSDP2.

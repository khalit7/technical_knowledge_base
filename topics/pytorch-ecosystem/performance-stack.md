...
- Rough triage order: memory snapshot for OOMs; profiler trace for throughput; NCCL
  flight recorder for hangs (see [distributed-pytorch.md](distributed-pytorch.md)).

Cross-refs: kernel authoring (Triton, Helion, CUTLASS) in
[../cuda-and-gpu-programming/](../cuda-and-gpu-programming/); quantization theory in

...
train.py`: spawns one process per GPU, sets `RANK/LOCAL_RANK/WORLD_SIZE/MASTER_*`,
...
Cross-refs: ZeRO/parallelism theory in
[../llm-training-and-post-training/](../llm-training-and-post-training/); compile
interactions in [torch-compile.md](torch-compile.md); framework-level wrappers
(accelerate, Axolotl) in [hf-and-training-frameworks.md](hf-and-training-frameworks.md).

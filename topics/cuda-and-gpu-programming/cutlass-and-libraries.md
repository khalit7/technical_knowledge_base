...
| Triton / Gluon | See [Triton](triton-language.md) | The pragmatic middle for custom ML kernels |
...
- Cross-reference: [Topic: hardware](../hardware/summary.md) for Blackwell architecture detail; [Topic: inference-and-serving](../inference-and-serving/summary.md) for where these kernels land in production stacks.

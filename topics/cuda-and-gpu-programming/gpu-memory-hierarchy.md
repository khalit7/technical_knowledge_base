...
FlashAttention's entire trick, applied to attention instead of GEMM: see
[writing-kernels.md](writing-kernels.md) and the
[FlashAttention paper](../../papers/2022-05_flashattention/summary.md).

## Practical diagnostics

- Nsight Compute "Speed of Light" section: % of peak memory vs compute tells you your
  roofline position immediately (details in [profiling-and-tools.md](profiling-and-tools.md)).

...
Cross-link: dataset composition and filtering strategy live in [Topic: data-curation-and-datasets](../data-curation-and-datasets/summary.md); this page owns the pipes.
